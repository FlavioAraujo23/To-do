...
const ViewsTodoState = ({mobile}) => {
  return (
    <main className={mobile? "w-max pl-1 pt-4" : "container pl-2 pt-4"}>
      <div className={mobile? 'flex-col w-max h-full pl-2': "w-full flex justify-around"}>
